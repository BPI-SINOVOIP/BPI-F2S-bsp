 ...
 * Static Functions
 **************************************************************************/
static int _i143_fb_pan_display(struct fb_var_screeninfo *var,
		struct fb_info *fbinfo);
static int _i143_fb_setcmap(struct fb_cmap *cmap, struct fb_info *info);
static int _i143_fb_ioctl(struct fb_info *fbinfo,
		unsigned int cmd,
		unsigned long arg);

static int _i143_fb_remove(struct platform_device *pdev);
static int _i143_fb_probe(struct platform_device *pdev);
...
MODULE_DEVICE_TABLE(of, _i143_fb_dt_ids);

static struct platform_driver _i143_fb_driver = {
	.probe		= _i143_fb_probe,
	.remove		= _i143_fb_remove,
	.driver		= {
		.name	= "i143-fb",
		.owner	= THIS_MODULE,
		.of_match_table = of_match_ptr(_i143_fb_dt_ids),
	},
};
module_platform_driver(_i143_fb_driver);

/**************************************************************************
 * Function Implementations
 **************************************************************************/
static int _i143_fb_create_device(struct platform_device *pdev,
 ...
 * Public Function
 ****************************************************************************/
unsigned int i143_fb_chan_by_field(unsigned char chan,
