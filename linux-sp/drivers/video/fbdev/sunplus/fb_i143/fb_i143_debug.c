...
static void _fill_color(char *ptr, int size, int argb, struct fb_info *info)
{
	...
	if (info->var.nonstd) {
		...
		color = i143_fb_chan_by_field(ARGB_GETA(argb),
				&info->var.transp);
		color |= i143_fb_chan_by_field(ARGB_GETR(argb),
				&info->var.red);
		color |= i143_fb_chan_by_field(ARGB_GETG(argb),
				&info->var.green);
		color |= i143_fb_chan_by_field(ARGB_GETB(argb),
				&info->var.blue);
	}
...
static void _fb_debug_cmd(char *tmpbuf, struct fb_info *fbinfo)
{
	...
	if (!strncasecmp(tmpbuf, "tpg", 3)) {
		...
		palette[index] = i143_fb_chan_by_field(ARGB_GETA(argb),
				&fbinfo->var.transp);
		palette[index] |= i143_fb_chan_by_field(ARGB_GETR(argb),
				&fbinfo->var.red);
		palette[index] |= i143_fb_chan_by_field(ARGB_GETG(argb),
				&fbinfo->var.green);
		palette[index] |= i143_fb_chan_by_field(ARGB_GETB(argb),
				&fbinfo->var.blue);
		...
		ret = i143_fb_swapbuf(buf_id, fb_par->fbpagenum);
		...
		bg_color = i143_fb_chan_by_field(ARGB_GETA(gFont_bg_color),
				&fbinfo->var.transp);
		bg_color |= i143_fb_chan_by_field(ARGB_GETR(gFont_bg_color),
				&fbinfo->var.red);
		bg_color |= i143_fb_chan_by_field(ARGB_GETG(gFont_bg_color),
				&fbinfo->var.green);
		bg_color |= i143_fb_chan_by_field(ARGB_GETB(gFont_bg_color),
				&fbinfo->var.blue);
		...
		font_color = i143_fb_chan_by_field(ARGB_GETA(gFont_color),
				&fbinfo->var.transp);
		font_color |= i143_fb_chan_by_field(ARGB_GETR(gFont_color),
				&fbinfo->var.red);
		font_color |= i143_fb_chan_by_field(ARGB_GETG(gFont_color),
				&fbinfo->var.green);
		font_color |= i143_fb_chan_by_field(ARGB_GETB(gFont_color),
				&fbinfo->var.blue);
