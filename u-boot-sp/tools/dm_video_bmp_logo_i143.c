...
void gen_info(FILE *fp, bitmap_t *b, uint16_t n_colors, uint32_t ffile_size, int ffile_type)
{
	...
	printf("/*\n"
		" * Automatically generated by \"tools/dm_video_bmp_logo_i143\"\n"
		" *\n"
		" * DO NOT EDIT\n"
		" *\n"
		" */\n\n\n"
		"#ifndef __I143_BMP_LOGO_H__\n"
		"#define __I143_BMP_LOGO_H__\n\n");

	if (ffile_type == FILE_TYPE_GZIP) {
		printf("/* FILE_TYPE_GZIP */\n");
		printf("#define BMP_LOGO_FILE_SIZE\t\t\t\t%d\n"
			"#define I143_LOGO_BMP_WIDTH\t\t\t%d\t/*depend*/\n"
			"#define I143_LOGO_BMP_HEIGHT\t\t\t%d\t/*depend*/\n"
			"#define I143_LOGO_BMP_X_OFFSET\t\t%d\t/*depend*/\n"
			"#define I143_LOGO_BMP_Y_OFFSET\t\t%d\t/*depend*/\n\n",
			ffile_size, 250, 100, 0, 0);
	}
	else if (ffile_type == FILE_TYPE_8BPP_BMP) {
		printf("/* FILE_TYPE_8BPP_BMP */\n");
		printf("#define BMP_LOGO_FILE_SIZE\t\t\t\t%d\n"
			"#define I143_LOGO_BMP_WIDTH\t\t\t%d\n"
			"#define I143_LOGO_BMP_HEIGHT\t\t\t%d\n"
			"#define I143_LOGO_BMP_X_OFFSET\t\t%d\n"
			"#define I143_LOGO_BMP_Y_OFFSET\t\t%d\n\n",
	...
	printf ("#endif /* __I143_BMP_LOGO_H__ */\n");
...
void gen_data(FILE *fp, bitmap_t *b, uint16_t n_colors, uint32_t ffile_size, int ffile_type)
{
	...
	printf("/*\n"
		...
		" *\n"
		" */\n\n\n"
		"#ifndef __I143_BMP_LOGO_DATA_H__\n"
		"#define __I143_BMP_LOGO_DATA_H__\n\n");
	...
	if (ffile_type == FILE_TYPE_GZIP)
		...
		printf("unsigned char i143_uboot_logo[] = {\n");
	...
	printf ("\n"
		"};\n\n"
		"#endif /* __I143_BMP_LOGO_DATA_H__ */\n"
	);
}
